...
- **Suggested command**: Which command to use (prefer: /bolder, /polish, /adapt, /harden, /distill, /animate, /normalize, /extract, /delight, /clarify, /arrange, /audit, /quieter, /colorize, /critique, /optimize, /onboard, /overdrive, /typeset — or other installed skills you're sure exist)
...
Map issues to available commands. Prefer these: /bolder, /polish, /adapt, /harden, /distill, /animate, /normalize, /extract, /delight, /clarify, /arrange, /audit, /quieter, /colorize, /critique, /optimize, /onboard, /overdrive, /typeset. You may also suggest other installed skills you're sure exist, but never invent commands.
